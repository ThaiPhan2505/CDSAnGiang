                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade active show" id="account" role="tabpanel">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form role="form" action="{{ URL::to('/crate_profile') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="mb-3 ">
                                            ...
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <select class="form-control form-select" id="loaihinh" name="LoaiHinh" aria-label=".form-select-sm">
                                                    ...
                                                    @foreach ( $LoaiHinh as $LV )
                                                    <option value="{{ $LV->Id }}">{{ $LV->TenNganhNghe }}</option>

                                                    @endforeach
                                                        {{-- @if ( $LV->Id == $DN->LinhVuc_id)
                                                        <option value="{{ $LV->Id }}" selected>{{ $LV->TenNganhNghe }}</option>
                                                        @else
                                                        <option value="{{ $LV->Id }}" >{{ $LV->TenNganhNghe }}</option>
                                                        @endif --}}
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-md-3">
                                            ...
                                            <select class="form-control form-select" id="city_NC" name="NoiCap" aria-label=".form-select-sm">
